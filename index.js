...
fs.writeFileSync("sync.js","“I love the Kalvium backend web development course”")
...
fs.writeFile("async.js","“I love the Kalvium backend web development course”",(err)=>{
if(err){
    console.log(err)
...
fs.writeFileSync("task3.js","“I love the Kalvium backend web development course”")
...
fs.writeFile("task4.js","“I love the Kalvium backend web development course”",(err)=>{
    if(err){
        console.log(err)
    }
})
